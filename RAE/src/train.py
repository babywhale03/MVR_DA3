...
def main():
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        for train_step, batch in enumerate(train_loader):
            ...
            if rank == 0 and training_cfg.vis.train_depth_every > 0 and global_train_step % training_cfg.vis.train_depth_every == 0 and global_train_step > 0:
            ...
            # validation
            if rank==0 and (len(full_cfg.data.val.list) != 0) and (training_cfg.vis.val_depth_every > 0)and (global_train_step % training_cfg.vis.val_depth_every) == 0 and global_train_step > 0:
