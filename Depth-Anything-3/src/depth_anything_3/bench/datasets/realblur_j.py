...
"""
RealBlur_J video deblurring dataset implementation.
"""
...
REALBLUR_J_DATA_ROOT = "/mnt/dataset1/MV_Restoration/restormer_benchmark/RealBlur_J"


@MV_REGISTRY.register(name="realblur_j")
@MONO_REGISTRY.register(name="realblur_j")
class RealBlurJ(Dataset):
    """
    RealBlur_J video deblurring dataset wrapper.
    
    Each scene contains sequential frames (blurred input + sharp target).
    """

    data_root = REALBLUR_J_DATA_ROOT
