...
"""
HIDE video deblurring dataset implementation.
"""
...
HIDE_DATA_ROOT = "/mnt/dataset1/MV_Restoration/restormer_benchmark/HIDE"


@MV_REGISTRY.register(name="hide")
@MONO_REGISTRY.register(name="hide")
class HIDE(Dataset):
    """
    HIDE video deblurring dataset wrapper.
