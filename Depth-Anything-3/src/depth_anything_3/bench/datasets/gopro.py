...
"""
GoPro video deblurring dataset implementation.
"""
...
GOPRO_DATA_ROOT = "/mnt/dataset1/MV_Restoration/restormer_benchmark/GoPro"


@MV_REGISTRY.register(name="gopro")
@MONO_REGISTRY.register(name="gopro")
class GoPro(Dataset):
    """
    GoPro video deblurring dataset wrapper.
    ...
    def get_data(self, scene: str) -> Dict:
        ...
        Args:
            scene: Scene identifier (e.g., "GOPR0384_11_00")
