...
class DepthAnything3(nn.Module, PyTorchModelHubMixin):
    ...
    def inference(
        ...
        if cfg.MVRM_EVAL.eval_method == 'w_mvrm':       
            ...
            xt = lq_latent + pure_noise * cfg.mvrm.noiselvl
            ...
            if cfg.mvrm.use_lq_cond:
                model_kwargs['lq_latent'] = lq_latent
                model_kwargs['lq_cond'] = cfg.mvrm.lq_latent_cond
            ...
            xt = lq_latents + pure_noise * cfg.mvrm.noiselvl
            ...
            if cfg.mvrm.use_lq_cond:
                model_kwargs['lq_latent'] = lq_latents
                model_kwargs['lq_cond'] = cfg.mvrm.lq_latent_cond
